...
! function (global, factory) {
    if ("function" == typeof define && define.amd) define("/Site", ["exports", "jquery", "Base", "Menubar", "Sidebar", "PageAside"], factory);
    else if ("undefined" != typeof exports) factory(exports, require("jquery"), require("Base"), require("Menubar"), require("Sidebar"), require("PageAside"));
    else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.jQuery, global.Base, global.SectionMenubar, global.SectionSidebar, global.SectionPageAside), global.Site = mod.exports
    }
    ...
    var _jquery2 = babelHelpers.interopRequireDefault(_jquery),
        ...
        Site = function (_Base) {
            ...
            return babelHelpers.inherits(Site, _Base), babelHelpers.createClass(Site, [{
                key: "initialize",
                value: function () {
                    this.startLoading(), this.initializePluginAPIs(), this.initializePlugins(), this.initComponents()
                }
            }, {
                key: "process",
                value: function () {
                ...
                value: function (type) {
                    (0, _jquery2.default)('[data-toggle="menubar"]').each(function () {
                        ...
                        $hamburger.length > 0 ? $hamburger.toggleClass("hided", !("open" === type)) : $this.toggleClass("hided", !("open" === type))
                    })
                }
            }, {
                key: "initComponents",
                ...
                value: function () {
                    ...
                    (0, _jquery2.default)(document).on("click", '[data-toggle="menubar"]', function () {
                        ...
                        return _this2.menubar.change(type), _this2.menubarType(type), !1
                    }), (0, _jquery2.default)(document).on("collapsed.site.menu expanded.site.menu", function () {
                        "open" === _this2.menubar.type && _this2.menubar && _this2.menubar.scrollable && _this2.menubar.scrollable.update()
                    }), Breakpoints.on("change", function () {
                        _this2.menubar.type = _this2._getDefaultMeunbarType(), _this2.menubar.change(_this2.menubar.type)
                    })
                }
            }, {
